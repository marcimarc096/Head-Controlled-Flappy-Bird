...
class Flappy_Game:
    ...
    def stage_text(self):
        text = pygame.font.SysFont(self.font, 50).render(f'Stage: {self.Game_Stage}', True, self.color)
        text_rect = text.get_rect()
        text_rect.center = (100, 50)
        self.game_screen.blit(text, text_rect)

    def score_text(self):
        text = pygame.font.SysFont(self.font, 50).render(f'Score: {self.game_score}', True, self.color)
        text_rect = text.get_rect()
